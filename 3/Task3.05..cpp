...
* @file         pr1.cpp
* @brief        Task3
* @task         5. Розробити функцію, яка вилучає з речення всі слова, 
* що містять  задану комбінацію символів. Ввести буквосполучення. 
* На основі розробленої функції вилучити з введеного речення всі слова, 
* що містять це буквосполучення. Роздрукувати результат.
