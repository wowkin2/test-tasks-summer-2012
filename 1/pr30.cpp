...
* @file         pr30.cpp
* @brief        Task1
* @task         30. Використовуючи тільки бітові операції, написати функцію,
яка повертає одиницю, якщо значення бітів у 2-х заданих позиціях беззнакового
довгого цілого числа є однаковими.
...
* @return       int 0 if numbers are different, 1 - equals
*/
