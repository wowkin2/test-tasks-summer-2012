...
* @file         pr24.cpp
* @brief        Task1
* @task         24. Використовуючи тільки бітові операції, написати функцію,
яка міняє місцями сусідні групи з 8-и бітів у заданому беззнаковому довгому цілому числі.
...
/**
* @brief        Change all 8-neighbors bites in ULI
